...
protocol SellViewImageDelegate: class{
    func addImageFinished()
    func deleteImageFinished()
    func refreshAllData()
}

protocol SellViewModeling {
...
class SellViewModel: SellViewModeling{
    ...
    let selectedCategory: PublishSubject<String> = PublishSubject<String>()
    ...
    //Shipping
    let shippingEnabled: BehaviorSubject<Bool> = BehaviorSubject<Bool>(value: true)
