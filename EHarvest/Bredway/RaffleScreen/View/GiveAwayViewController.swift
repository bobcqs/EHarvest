...
class GiveAwayViewController: UIViewController, GenericReturnAction {

    @IBOutlet weak var tableView: UITableView!
    
    var viewModel: GiveAwayViewModeling?
    ...
    override func viewDidDisappear(_ animated: Bool) {
        NotificationCenter.default.post(name: .stopGiveAwayTimer, object: nil, userInfo: nil)
        super.viewDidDisappear(animated)
    }
    
    func setupBinding(){
        viewModel?.sliders
            .drive(tableView.rx.items(cellIdentifier: "GiveAwayTableViewCell", cellType: GiveAwayTableViewCell.self)) { (row, element, cell) in
